...
BEGIN_MESSAGE_MAP(CWfguiDlg, CDialog)
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_RADIO4, &CWfguiDlg::OnBnClickedRadio4)
	ON_BN_CLICKED(IDC_RADIO5, &CWfguiDlg::OnBnClickedRadio5)
END_MESSAGE_MAP()
...
//	Dlg.DoModal();
  ...
  m_OScopeCtrl.SetRange(-0.5, 0.5, 2) ;
...
void CWfguiDlg::OnRadio2() 
{
	...
	m_OScopeCtrl.SetRange(-0.5, 0.5, 2) ;
 //m_metercontrol.SetRange(0,5000);
	m_3DMeterCtrl.SetRange(0.0, 0.5); 
...
void CWfguiDlg::OnBnClickedRadio4()
{
	...
	m_OScopeCtrl.SetRange(-3.0, 3.0, 2) ;
	m_3DMeterCtrl.SetRange(0.0, 3.0); 
}
